...
<head>
	...
	<title>Iron Gym | Ver rutina</title>
				...
				<tbody>
					...
					if (mysqli_affected_rows($con) != 0) {
						while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
							...
							echo '<td><a href="editdetailroutine.php?id=' . $row['id_horario'] . '">
								<input type="button" class="a1-btn a1-blue" id="boxxe" value="Editar Rutina" >
								</a></td>';
							// echo '<td><a href="deleteroutine.php?id='.$row['tid'].'"><input type="button" class="a1-btn a1-blue" value="Delete Routine" ></a></td></tr>';
							echo "<td><form action='deleteroutine.php' method='post' onsubmit='return ConfirmDelete()'>
								<input type='hidden' name='name' value='" . $row['id_horario'] . "'/>
								<input type='submit' value='Eliminar' width='20px' id='boxxe' class='a1-btn a1-orange'/>
								</form></td></tr>";
